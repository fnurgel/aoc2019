...
void explore_neighbours(int r, int c) {
    ...
    for (int i=0; i<4; i++) {
        ...
        if (is_character(maze[maze_y][maze_x])) {
            ...
            string portal_name = portals[coord_id_portal];
            ...
            if (sizeof(coords) == 2) {
                ...
                if (sizeof(coords) == 1) {
                    ...
                    rr = maze_y;
                    cc = maze_x;
                    write(sprintf("Portal %s -> %d,%d\n", portal_name, maze_y, maze_x));
                    jumping = 1;
                } else {
...
int start_oxygen_r = 0;
int start_oxygen_c = 0;
int start_r=0;
int start_c=0;
int move_count = 0;
